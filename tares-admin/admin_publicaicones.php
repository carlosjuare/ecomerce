  ...
  <div class="col-md-6">
    <div class="card h-100">
      <?php
        ...
        $url_mod = "modificar_publicacion.php?tipo=$tipo&id=$id_pub";
        $url_del = "eliminar_publicacion.php?tipo=$tipo&id=$id_pub";
      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between mt-3">
          <a href="modificar_publicacion.php?id=<?= $row['id_publicacion'] ?>&tipo=<?= $tipo ?>" class="btn btn-warning">Modificar</a>

          <a href="<?= htmlspecialchars($url_del) ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de eliminar esta publicación?')">Eliminar</a>
        </div>
      </div>
    </div>
  </div>
